import { getPrismaClient, type PrismaClientLike } from "@flarerail/core";
...
export type ActorType = "system" | "wallet_operator" | "partner_api" | "worker";
...
export async function createLifecycleEvent(
  ...
  await prisma.lifecycleEvent.create({
    data: {
      ...
      actorType: input.actorType as any, // Prisma enum
