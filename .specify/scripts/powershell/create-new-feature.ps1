...
# Function to generate feature identifier with stop word filtering and length filtering
...
# GitHub enforces a 244-byte limit on branch names; the generated feature
# identifier is used as the feature directory name, so the same guard applies.
...
if ($branchName.Length -gt $maxBranchLength) {
    ...
    Write-Warning "[specify] Feature identifier exceeded GitHub's 244-byte limit"
...
if ($Json) {
    ...
    Write-Output "FEATURE_NAME: $branchName"
